document.getElementById('descargarpdf').addEventListener('click', function() {
  var url = 'docs/cap5.pdf'; // Reemplaza con la URL de tu archivo PDF o Word
...
document.getElementById('descargarword').addEventListener('click', function() {
  var url = 'docs/cap5.docx'; // Reemplaza con la URL de tu archivo PDF o Word
